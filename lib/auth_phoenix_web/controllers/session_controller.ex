defmodule AuthPhoenixWeb.SessionController do
  use AuthPhoenixWeb, :controller

  alias AuthPhoenix.Accounts
  alias AuthPhoenix.Guardian
    ...
    case Accounts.authenticate_user(email, password) do
      {:ok, user} ->
        {:ok, access_token, _claims} =
          Guardian.encode_and_sign(user, %{}, token_type: "access", title: {15, :minute})

        {:ok, refresh_token, _claims} =
          Guardian.encode_and_sign(user, %{}, token_type: "refresh", title: {7, :day})
